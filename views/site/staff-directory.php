...
.actions-menu { display: none; position: absolute; right: 0; top: calc(100% + 6px); background: #fff; border: 1px solid #eceef1; border-radius: 10px; box-shadow: 0 8px 24px rgba(0,0,0,.08); min-width: 190px; z-index: 20; overflow: hidden; }
            ...
            <?php else: ?>
                <table class="staff-table">
                    ...
                    <tbody id="staffTableBody">
                        ...
                        ?>
                        <tr data-status="<?= Html::encode($m->status) ?>" data-search="<?= Html::encode(strtolower($m->username . ' ' . $m->email)) ?>">
                           <td>
